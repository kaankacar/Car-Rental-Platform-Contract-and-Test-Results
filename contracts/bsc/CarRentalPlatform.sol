...
contract CarRentalPlatform is ReentrancyGuard {
    ...
    event Depozit(address indexed walletAddress, uint amount);
    ...
    function checkOut(uint id) external {
      ...
      require(cars[id].status == Status.Available, "Car's not available");
    ...
    function isUser(address _walletAddress) private view returns(bool){
      return users[_walletAddress].walletAdress != address(0);
    }
...
//    > transaction hash:    0x559afc1060bf87bd2c9186e39e85531928002ccd67088cbe3545f3a41bd400e7
//    > Blocks: 0            Seconds: 0
//    > contract address:    0xc31557fEa17c4A0c2a728cb86f6e9bD871341F07
//    > block number:        15
//    > block timestamp:     1686004867
//    > account:             [REDACTED]
//    > balance:             999.947169687061125091
//    > gas used:            3328171 (0x32c8ab)
//    > gas price:           2.654307478 gwei
//    > value sent:          0 ETH
//    > total cost:          0.008833989173362738 ETH
...
// =======
// > Total deployments:   1
// > Final cost:          0.008833989173362738 ETH